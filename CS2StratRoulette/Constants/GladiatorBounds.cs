...
namespace CS2StratRoulette.Constants
{
	public static class GladiatorBounds
	{
		public static readonly GladiatorMapBounds Mirage = new(
			...
			{
				// CT -> A
				(new(-1038f, -2588f, -153f), new(0f, 90f, 0f)),
				(new(-1038f, -2448f, -153f), new(0f, 90f, 0f)),
				(new(-1038f, -2308f, -153f), new(0f, 90f, 0f)),
				// CT -> Window
				(new(-1335f, -1050f, -165f), new(0f, 90f, 0f)),
				// CT -> Market
				(new(-1544f, -735f, -166f), new(0f, -180f, 0f)),
			},
			(new(-1760f, -1300f, -153f), new(-1850f, -1620f, -153f)),
