...
namespace CS2StratRoulette.Constants
{
	public static class Signatures
	{
		...
		public const string CSmokeGrenadeProjectile_CreateFunction =
		...
		public static readonly MemoryFunctionWithReturn<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, int> CreateSmoke =
			new(Signatures.CSmokeGrenadeProjectile_CreateFunction);
